...
lv_obj_t * ui_blood_pressure = NULL;
lv_obj_t * ui_bg2 = NULL;
lv_obj_t * ui_Image3 = NULL;
lv_obj_t * ui_title_group_3 = NULL;
lv_obj_t * ui_button_down7 = NULL;
lv_obj_t * ui_button_round2 = NULL;
lv_obj_t * ui_blood_presure_group1 = NULL;
lv_obj_t * ui_sys_group = NULL;
lv_obj_t * ui_sys = NULL;
lv_obj_t * ui_mmhg1 = NULL;
lv_obj_t * ui_blood_oxygen1 = NULL;
lv_obj_t * ui_pulse_group2 = NULL;
lv_obj_t * ui_blood_presure_group2 = NULL;
lv_obj_t * ui_dia_group = NULL;
lv_obj_t * ui_dia = NULL;
lv_obj_t * ui_mmhg2 = NULL;
lv_obj_t * ui_blood_oxygen2 = NULL;
lv_obj_t * ui_health_dots_group2 = NULL;
lv_obj_t * ui_dot12 = NULL;
lv_obj_t * ui_dot13 = NULL;
lv_obj_t * ui_dot11 = NULL;
// event funtions
...
void ui_blood_pressure_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_blood_pressure, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_bg2 = lv_image_create(ui_blood_pressure);
    lv_image_set_src(ui_bg2, &ui_img_bg3_png);
    ...
    ui_Image3 = lv_image_create(ui_blood_pressure);
    lv_image_set_src(ui_Image3, &ui_img_s9_png);
    ...
    lv_image_set_src(ui_comp_get_child(ui_button_down7, UI_COMP_BUTTONDOWN_BUTTON_DOWN_ICON), &ui_img_house_png);
    ...
    lv_obj_remove_flag(ui_blood_presure_group1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_sys_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_blood_presure_group2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_dia_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_health_dots_group2, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_dot12, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_dot13, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_dot11, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
...
void ui_blood_pressure_screen_destroy(void)
{
    if(ui_blood_pressure) lv_obj_del(ui_blood_pressure);

    // NULL screen variables
    ui_blood_pressure = NULL;
    ui_bg2 = NULL;
    ui_Image3 = NULL;
    ui_title_group_3 = NULL;
    ui_button_down7 = NULL;
    ui_button_round2 = NULL;
    ui_blood_presure_group1 = NULL;
    ui_sys_group = NULL;
    ui_sys = NULL;
    ui_mmhg1 = NULL;
    ui_blood_oxygen1 = NULL;
    ui_pulse_group2 = NULL;
    ui_blood_presure_group2 = NULL;
    ui_dia_group = NULL;
    ui_dia = NULL;
    ui_mmhg2 = NULL;
    ui_blood_oxygen2 = NULL;
    ui_health_dots_group2 = NULL;
    ui_dot12 = NULL;
    ui_dot13 = NULL;
    ui_dot11 = NULL;
