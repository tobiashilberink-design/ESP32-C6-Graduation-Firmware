...
void ui_Screen_2_Move_screen_init(void)
{
    ...
    lv_imgbtn_set_src(ui_BTN_Reset, LV_IMGBTN_STATE_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Reset, LV_IMGBTN_STATE_CHECKED_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Heat, LV_IMGBTN_STATE_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Heat, LV_IMGBTN_STATE_CHECKED_DISABLED, NULL, &ui__temporary_image, NULL);
