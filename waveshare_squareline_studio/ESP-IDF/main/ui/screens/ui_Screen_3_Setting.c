...
void ui_Screen_3_Setting_screen_init(void)
{
    ...
    lv_imgbtn_set_src(ui_BTN_Heat_Head, LV_IMGBTN_STATE_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Heat_Head, LV_IMGBTN_STATE_CHECKED_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Heat_Bed, LV_IMGBTN_STATE_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Heat_Bed, LV_IMGBTN_STATE_CHECKED_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Remove_Filament, LV_IMGBTN_STATE_DISABLED, NULL, &ui__temporary_image, NULL);
    ...
    lv_imgbtn_set_src(ui_BTN_Remove_Filament, LV_IMGBTN_STATE_CHECKED_DISABLED, NULL, &ui__temporary_image, NULL);
