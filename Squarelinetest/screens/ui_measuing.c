...
lv_obj_t * ui_measuing = NULL;
lv_obj_t * ui_bg7 = NULL;
lv_obj_t * ui_pulse_group3 = NULL;
lv_obj_t * ui_measuring = NULL;
lv_obj_t * ui_Spinner2 = NULL;
lv_obj_t * ui_blood_group = NULL;
lv_obj_t * ui_blood1 = NULL;
lv_obj_t * ui_blood_fill = NULL;
lv_obj_t * ui_blood2 = NULL;
lv_obj_t * ui_x_button = NULL;
lv_obj_t * ui_x = NULL;
// event funtions
...
void ui_measuing_screen_init(void)
{
    ...
    ui_bg7 = lv_image_create(ui_measuing);
    lv_image_set_src(ui_bg7, &ui_img_bg3_png);
    ...
    lv_obj_remove_flag(ui_bg7, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Spinner2 = lv_spinner_create(ui_measuing);
    ...
    lv_obj_remove_flag(ui_blood_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_blood1 = lv_image_create(ui_blood_group);
    lv_image_set_src(ui_blood1, &ui_img_wave2_png);
    ...
    lv_obj_remove_flag(ui_blood1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_inner_align(ui_blood1, LV_IMAGE_ALIGN_TILE);
    ...
    lv_obj_remove_flag(ui_blood_fill, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_blood2 = lv_image_create(ui_blood_group);
    lv_image_set_src(ui_blood2, &ui_img_wave1_png);
    ...
    lv_obj_remove_flag(ui_blood2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_inner_align(ui_blood2, LV_IMAGE_ALIGN_TILE);

    ui_x_button = lv_button_create(ui_measuing);
    ...
    lv_obj_remove_flag(ui_x_button, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_x = lv_image_create(ui_x_button);
    lv_image_set_src(ui_x, &ui_img_x_png);
    ...
    lv_obj_remove_flag(ui_x, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
...
void ui_measuing_screen_destroy(void)
{
    if(ui_measuing) lv_obj_del(ui_measuing);

    // NULL screen variables
    ui_measuing = NULL;
    ui_bg7 = NULL;
    ui_pulse_group3 = NULL;
    ui_measuring = NULL;
    ui_Spinner2 = NULL;
    ui_blood_group = NULL;
    ui_blood1 = NULL;
