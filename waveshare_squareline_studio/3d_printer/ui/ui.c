...
void ui_event_BTN_Menu_Move_S1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Screen_2_Move, LV_SCR_LOAD_ANIM_FADE_ON, 10, 0, &ui_Screen_2_Move_screen_init);
    }
}
void ui_event_BTN_Menu_Setting_S1(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Screen_3_Setting, LV_SCR_LOAD_ANIM_FADE_ON, 10, 0, &ui_Screen_3_Setting_screen_init);
    }
}
void ui_event_Slider_Print_View(lv_event_t * e)
{
...
void ui_event_BTN_Menu_Print_S2(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Screen_1_Print, LV_SCR_LOAD_ANIM_FADE_ON, 1, 0, &ui_Screen_1_Print_screen_init);
    }
}
void ui_event_BTN_Menu_Setting_S2(lv_event_t * e)
{
...
void ui_event_BTN_Menu_Print_S3(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Screen_1_Print, LV_SCR_LOAD_ANIM_FADE_ON, 10, 0, &ui_Screen_1_Print_screen_init);
    }
}
void ui_event_BTN_Menu_Move_S3(lv_event_t * e)
{
