...
lv_obj_t * ui_blood_oxy = NULL;
lv_obj_t * ui_bg6 = NULL;
lv_obj_t * ui_title_group_1 = NULL;
lv_obj_t * ui_button_down5 = NULL;
lv_obj_t * ui_button_round = NULL;
lv_obj_t * ui_blood_presure_group = NULL;
lv_obj_t * ui_blood_oxygen = NULL;
lv_obj_t * ui_percent = NULL;
lv_obj_t * ui_pulse_group = NULL;
lv_obj_t * ui_arc_spo2 = NULL;
lv_obj_t * ui_precent_70 = NULL;
lv_obj_t * ui_precent_100 = NULL;
lv_obj_t * ui_health_dots_group = NULL;
lv_obj_t * ui_dot7 = NULL;
lv_obj_t * ui_dot6 = NULL;
lv_obj_t * ui_dot5 = NULL;
lv_obj_t * ui_dots_group1 = NULL;
lv_obj_t * ui_dot18 = NULL;
lv_obj_t * ui_dot19 = NULL;
// event funtions
...
void ui_blood_oxy_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_blood_oxy, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_bg6 = lv_image_create(ui_blood_oxy);
    lv_image_set_src(ui_bg6, &ui_img_bg3_png);
    ...
    lv_image_set_src(ui_comp_get_child(ui_button_down5, UI_COMP_BUTTONDOWN_BUTTON_DOWN_ICON), &ui_img_house_png);
    ...
    lv_obj_remove_flag(ui_blood_presure_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_arc_spo2, LV_OBJ_FLAG_CLICKABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_health_dots_group, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_dots_group1, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_dot18, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_dot19, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
...
void ui_blood_oxy_screen_destroy(void)
{
    if(ui_blood_oxy) lv_obj_del(ui_blood_oxy);

    // NULL screen variables
    ui_blood_oxy = NULL;
    ui_bg6 = NULL;
    ui_title_group_1 = NULL;
    ui_button_down5 = NULL;
    ui_button_round = NULL;
    ui_blood_presure_group = NULL;
    ui_blood_oxygen = NULL;
    ui_percent = NULL;
    ui_pulse_group = NULL;
    ui_arc_spo2 = NULL;
    ui_precent_70 = NULL;
    ui_precent_100 = NULL;
    ui_health_dots_group = NULL;
    ui_dot7 = NULL;
    ui_dot6 = NULL;
    ui_dot5 = NULL;
    ui_dots_group1 = NULL;
