...
{
    ui_watch_digital_screen_destroy();
    ui_watch_analog_screen_destroy();
    ui_call_screen_destroy();
    ui_weather_1_screen_destroy();
    ui_weather_2_screen_destroy();
    ui_blood_oxy_screen_destroy();
    ui_ecg_screen_destroy();
    ui_blood_pressure_screen_destroy();
    ui_measuing_screen_destroy();
}
