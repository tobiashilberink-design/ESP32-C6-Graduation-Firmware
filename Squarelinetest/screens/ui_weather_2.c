...
lv_obj_t * ui_weather_2 = NULL;
lv_obj_t * ui_bg5 = NULL;
lv_obj_t * ui_weather_dots_group1 = NULL;
lv_obj_t * ui_dot3 = NULL;
lv_obj_t * ui_dot4 = NULL;
lv_obj_t * ui_content = NULL;
lv_obj_t * ui_city_gruop_2 = NULL;
lv_obj_t * ui_todady_weather_content = NULL;
lv_obj_t * ui_today_weather_group = NULL;
lv_obj_t * ui_today_weather_group1 = NULL;
lv_obj_t * ui_today_weather_group2 = NULL;
lv_obj_t * ui_today_weather_group3 = NULL;
lv_obj_t * ui_today_weather_group4 = NULL;
lv_obj_t * ui_today_weather_group5 = NULL;
lv_obj_t * ui_today_weather_group6 = NULL;
lv_obj_t * ui_today_weather_group7 = NULL;
lv_obj_t * ui_today_weather_group8 = NULL;
lv_obj_t * ui_days_forecast = NULL;
lv_obj_t * ui_week_weather_group = NULL;
lv_obj_t * ui_forecast_group = NULL;
lv_obj_t * ui_forecast_group1 = NULL;
lv_obj_t * ui_forecast_group2 = NULL;
lv_obj_t * ui_forecast_group3 = NULL;
lv_obj_t * ui_forecast_group4 = NULL;
lv_obj_t * ui_forecast_group5 = NULL;
lv_obj_t * ui_space = NULL;
lv_obj_t * ui_button_down4 = NULL;
// event funtions
...
void ui_weather_2_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_weather_2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_bg5 = lv_image_create(ui_weather_2);
    lv_image_set_src(ui_bg5, &ui_img_bg3_png);
    ...
    lv_obj_remove_flag(ui_bg5, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_weather_dots_group1, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_image_set_src(ui_comp_get_child(ui_today_weather_group, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN),
    ...
    lv_image_set_src(ui_comp_get_child(ui_today_weather_group1, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN),
    ...
    lv_image_set_src(ui_comp_get_child(ui_today_weather_group2, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN),
                     &ui_img_weather_sun_cloud_png);
    ...
    lv_image_set_src(ui_comp_get_child(ui_today_weather_group4, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN),
    ...
    lv_obj_remove_flag(ui_week_weather_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_image_set_src(ui_comp_get_child(ui_forecast_group, UI_COMP_FORECASTGROUP_CLOUD_SUN), &ui_img_weather_cloud_fog_png);
    ...
    lv_image_set_src(ui_comp_get_child(ui_forecast_group2, UI_COMP_FORECASTGROUP_CLOUD_SUN), &ui_img_weather_cloud_png);
    ...
    lv_image_set_src(ui_comp_get_child(ui_forecast_group3, UI_COMP_FORECASTGROUP_CLOUD_SUN), &ui_img_weather_cloud_fog_png);
    ...
    lv_obj_remove_flag(ui_space, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_image_set_src(ui_comp_get_child(ui_button_down4, UI_COMP_BUTTONDOWN_BUTTON_DOWN_ICON), &ui_img_house_png);
...
void ui_weather_2_screen_destroy(void)
{
    if(ui_weather_2) lv_obj_del(ui_weather_2);

    // NULL screen variables
    ui_weather_2 = NULL;
    ui_bg5 = NULL;
    ui_weather_dots_group1 = NULL;
    ui_dot3 = NULL;
    ui_dot4 = NULL;
    ui_content = NULL;
    ui_city_gruop_2 = NULL;
    ui_todady_weather_content = NULL;
    ui_today_weather_group = NULL;
    ui_today_weather_group1 = NULL;
    ui_today_weather_group2 = NULL;
    ui_today_weather_group3 = NULL;
    ui_today_weather_group4 = NULL;
    ui_today_weather_group5 = NULL;
    ui_today_weather_group6 = NULL;
    ui_today_weather_group7 = NULL;
    ui_today_weather_group8 = NULL;
    ui_days_forecast = NULL;
    ui_week_weather_group = NULL;
    ui_forecast_group = NULL;
    ui_forecast_group1 = NULL;
    ui_forecast_group2 = NULL;
    ui_forecast_group3 = NULL;
    ui_forecast_group4 = NULL;
    ui_forecast_group5 = NULL;
    ui_space = NULL;
    ui_button_down4 = NULL;
